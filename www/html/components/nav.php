...
<aside class="main-sidebar">
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li <?php if($pg=="camera.php"){echo $act;}?>><a href="camera.php"><i class="fa fa-arrows"></i> <span>Camera</span></a></li>
        <li <?php if($pg=="remote2.php"){echo $act;}?>><a href="remote2.php"><i class="fa fa-arrows"></i> <span>Remote Control</span></a></li>
